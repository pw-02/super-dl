...
class CustomBatchSampler(Sampler):
    def __init__(self, dataset_size, batch_size, grpc_server_address='localhost:50051', send_interval=60, batch_count_threshold=500):
        ...
        self.stub = yourprotobuffile_pb2_grpc.CacheManagementStub(self.channel)
    ...
    def _send_batches_to_grpc(self, batches):
        ...
        request = yourprotobuffile_pb2.BatchIds(ids=batches)
...
custom_sampler = CustomBatchSampler(dataset_size=len(dataset), batch_size=batch_size)
