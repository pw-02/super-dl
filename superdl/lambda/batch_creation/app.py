...
#model_file = 'superdl/lambda/batch_creation/model'
model = Net()
...
def lambda_handler(event, context):
    # Sample base64-encoded image string with padding
    ...
    decoded_bytes = base64.b64decode(image_content_base64)

    image = Image.open(BytesIO(decoded_bytes)).convert(mode='L')
