...
class SuperClient:
    ...
    def create_client(self, server_address='localhost:50051'):
    ...
    def share_batch_access_pattern(self, job_id, batches):
...
def run_client():
    ...
    # Share batch access pattern without awaiting
    client.share_batch_access_pattern(job_id, batches)
