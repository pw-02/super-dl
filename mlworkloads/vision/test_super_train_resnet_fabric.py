...
def setup(config_file: str, devices: int = 1, precision: Optional[str] = None, resume: Union[bool, Path] = False) -> None:
...
if __name__ == "__main__":
    ...
    CLI(setup(config_file='mlworkloads/cfgs/resnet18.yaml'))